...
> Currently crafting interactive digital experiences, generative tools, and prompt systems.
...
```text
[ Core Focus ]   AI & Prompt Engineering • Audio Design • Generative Art (3D/WebGL)
[ Frontend   ]   React • Next.js • Tailwind CSS • Web3 • HTML5 & CSS3
[ Languages  ]   JavaScript • TypeScript • Python • GLSL
[ Workflows  ]   Git • REST APIs • GraphQL • CI/CD
```
...
### 🔮 System Focus & Operations

- **Creative Technology**: Blending generative audio (modular synthesis patches) and WebGL volumetric graphics (Three.js/p5.js).
- **AI Engineering**: Designing custom prompt architectures, agentic pipelines, and LLM-assisted context integrations.
- **Web3 & Blockchain**: Exploring smart contracts, decentralized apps, and digital audio ownership.
- **Meaning Engineering**: Constructing knowledge graphs and training both machine & biological neural networks.
